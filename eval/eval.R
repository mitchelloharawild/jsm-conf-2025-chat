...
sessions <- tribble(
  ~input, ~target,
  "What talks is Hadley giving this year?", "Hadley is giving a keynote session on Thursday, Sep 18
4:15 PM - 5:15 PM EDT in the Centennial Ballroom",
  ...
  "Are there any sessions about causal inference", "Yes there will be a workshop titled Causal Inference in R led by Malcolm Barret and Lucy D'Agostino McGowan on Tuesday, Sep 16
